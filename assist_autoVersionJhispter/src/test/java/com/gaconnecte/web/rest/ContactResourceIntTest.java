...
import com.gaconnecte.repository.ContactRepository;
import com.gaconnecte.repository.search.ContactSearchRepository;
...
public class ContactResourceIntTest {
    ...
    private static final Boolean DEFAULT_IS_GERANT = false;
    private static final Boolean UPDATED_IS_GERANT = true;
    ...
    public void createContact() throws Exception {
        ...
        assertThat(testContact.isIsGerant()).isEqualTo(DEFAULT_IS_GERANT);
    ...
    public void getAllContacts() throws Exception {
        ...
        restContactMockMvc.perform(get("/api/contacts?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].isGerant").value(hasItem(DEFAULT_IS_GERANT.booleanValue())));
    }
    ...
    public void getContact() throws Exception {
        ...
        restContactMockMvc.perform(get("/api/contacts/{id}", contact.getId()))
            ...
            .andExpect(jsonPath("$.isGerant").value(DEFAULT_IS_GERANT.booleanValue()));
    }
    ...
    public void updateContact() throws Exception {
        ...
        Contact testContact = contactList.get(contactList.size() - 1);
        assertThat(testContact.isIsGerant()).isEqualTo(UPDATED_IS_GERANT);
