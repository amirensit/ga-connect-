...
export class ContratDialogComponent implements OnInit {
    ...
    ngOnInit() {
       ...
       if (this.contrat.id !== undefined) {
        ...
        this.contrat.assure=new Assuree(null,new Personne(),null);
        ...
        this.assureeService.query()
            .subscribe((res: ResponseWrapper) => { this.assurees = res.json;console.log(this.assurees) }, (res: ResponseWrapper) => this.onError(res.json));
    ...
    saveVoiture() {
        if (this.contrat.voiture.id !== undefined) {
            ...
            this.subscribeToSaveResponseVoiture(
                this.voitureService.create(this.contrat.voiture));
        }
    }
