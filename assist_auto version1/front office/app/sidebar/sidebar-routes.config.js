"use strict";
exports.ROUTES = [
    { path: 'roles', title: 'Gestion des roles', icon: 'person', class: '' },
    { path: 'utilisateurs', title: 'Gestion des utilisateurs', icon: 'person', class: '' },
    ...
    //{ path: 'hello', title: 'hello',  icon:'notifications', class: '' },
    //{ path: 'upgrade', title: 'Upgrade to PRO',  icon:'unarchive', class: 'active-pro' },
    { path: 'contrats', title: 'contrat', icon: 'location_on', class: '' },
];
